...
<html>
<head>
<title>Welcome to HALWA Registration System</title>
...
function isNumeric(value) {
	...
	function cmouseoverPass(obj) {
		  var obj = document.getElementById('cmyPassword');
		  obj.type = "text";
		}
	function cmouseoutPass(obj) {
		  var obj = document.getElementById('cmyPassword');
		  obj.type = "password";
		}
...
<body>
	...
	<table width="80%" align="center"  border="2">
		<tbody><tr>
			<td>
			<div id="header">&nbsp;
			<div align="center">HALWA Registration System</div>
			</div>
			...
			<table>
						...
						<tbody><tr>
							<td width="90">
								<div id="menu" align="center">
									<a href="<jstlcore:url value="/index.jsp"/>">Login Page </a>
								</div>
							</td>							
						</tr>
					</tbody></table>
				...
				<tr>
					...
					<table align="center" border="0">
					   ...
					   <tr>			
							<td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
							Last Name: </td><td><input type="text" name="LASTNAME" size="25"/></td>
							
					   </tr>
					   <tr>
							<td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
							User Name:</td><td><input type="text" name="USERNAME" size="25"/></td> 
							
					   </tr>
					   <tr>
						    <td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
						    Password:</td><td><input type="password" id="myPassword" name="PASSWORD" size="25" required="required"/></td>
						   
					   </tr>
					   <tr>
						    <td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
						    Confirm Password:</td><td><input type="password" id="cmyPassword" name="CPASSWORD" size="25"/></td>
						   
					   </tr>
					   <tr>
						   <td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
						    Email: </td><td> <input type="email" name="EMAIL" size="25"/></td> 
						    
					   </tr>
					   <tr>
                           <td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
                           Phone Number:</td><td><input type="text" name="PHONENO" size="25"/></td>
